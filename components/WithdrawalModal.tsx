        ...
        {step === 3 && (
          <div className="flex flex-col space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-[14px] text-gray-700">
              <p className="mb-5 text-center px-2">الرجاء ربط محفظة الاستلام النهائية. تأكد من استخدام شبكة <span className="font-black text-[#1F6AE1]">BEP-20 (Binance Smart Chain)</span> حصراً.</p>
          ...
          <div className="flex flex-col space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-[13px] leading-[1.6] text-gray-700">
              ...
              <div className="bg-gray-50/80 p-4 rounded-2xl text-gray-600 text-[11px] border border-gray-200 mb-5 italic">
                <span className="font-bold text-gray-800 block mb-1">إحاطة تنظيمية:</span> بناءً على البروتوكول المنظم، تم تخفيض الرسوم التشغيلية بناءً على تسوية خاصة مع Mini Pro بموجب بروتوكول الاتفاق المنظم للمنصة. هذه الرسوم مطلوبة لفتح قناة السيولة الفورية.
              </div>
